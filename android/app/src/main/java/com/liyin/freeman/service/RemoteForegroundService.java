...
public class RemoteForegroundService extends Service {
    ...
    private void startService(){
        Log.d("KeepAlive","RemoteForegroundService startService");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("[KeepAlive]","RemoteForegroundService onStartCommand");
        // 绑定另外一个服务
        bindService();
    ...
    class Connection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            // 服务绑定成功时回调
            Log.d("[KeepAlive]","RemoteForegroundService onServiceConnected");
        }
