import 'package:freeman/model/v2_tim_group_at_info.dart';
...
class V2TimConversation {
  ...
  V2TimConversation.fromJson(Map json) {
    ...
    conversationID = Utils.StringToInt(json['conversationID']);
    type = json['type'];
    userID = uid;
    groupID = gid;
  ...
  String toLogString() {
    String res =
        "conversationID:$conversationID|type:$type|userID:$userID|groupID:$groupID|showName:$showName|groupType:$groupType|unreadCount:$unreadCount|isPinned:$isPinned|recvOpt:$recvOpt|customData:$customData|c2cReadTimestamp:$c2cReadTimestamp|groupReadSequence:$groupReadSequence|lastMessage:${lastMessage?.randID}";
    return res;
  }
}
// {
